...
Sempre atualize `context.md` ao alterar objetivo, estrutura, metricas, metodologia, limitacoes, ultimas alteracoes ou proximos passos.

## Publicacao no GitHub

O projeto esta preparado para upload manual. Consulte `docs/PUBLICACAO_GITHUB.md`.

Antes de adicionar arquivos ao Git, confirme que as pastas abaixo continuam ignoradas:
...
O `.gitignore` exclui dados locais, builds, executaveis, logs, caches, ambientes virtuais e exports.
